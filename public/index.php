...
<div class="grid">
  <section class="card">
    <h1>Gobfish — Status</h1>
    <p class="muted">blah bloody blah. This is a simple demo page showing your Twitch identity (if connected) and the latest users in the database.</p>
    <p class="muted">This should be where we see the character sheet.</p>
    <div class="muted" style="margin-top:1rem;font-size:.9rem">Gobfish by <a href="https://ellipsis.dev" target="_blank" rel="noopener" style="color:#ccc">Ellipsis_Goblins</a> | <a href="https://www.psycholabs.com" target="_blank" rel="noopener" style="color:#ccc">Psycholabs</a> </div>
